...
ALTER TABLE ADD CONSTRAINT unique_player UNIQUE (id, person_id);
...
CREATE TABLE baby_foot_token (
    ...
    name VARCHAR(25) NOT NULL,
    token_price VARCHAR(25) NOT NULL,
...
ALTER TABLE ADD CONSTRAINT unique_baby_foot_token UNIQUE (baby_foot_id, start_date);
